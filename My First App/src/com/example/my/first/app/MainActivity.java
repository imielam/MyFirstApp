...
public class MainActivity extends Activity {
    ...
    /**
     * called when the user click http button. open new activity to connect to internet
     * @param view
     */
    ...
    public void sendMessage(View view){
    	/**
    	 * uruchominie wewnętrznej aplikacji (pobranie numetu telefonu z pola tekstowego i wuruchomienie telefonuz  nim
    	 */
